##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.13.0-B3] date: [Thu Apr 08 21:29:47 CST 2021] 
##########################################################################################################################
...
-include $(ROOT_DIR)/DIR.mk
-include $(ROOT_DIR)/HAL_SOURCES.mk
...
C_SOURCES += $(CMSIS_SOUECES)


# ASM sources
ASM_SOURCES =  \
$(ROOT_DIR)/startup_stm32f103xe.s
...
#######################################
# link script
LDSCRIPT = $(ROOT_DIR)/STM32F103VETx_FLASH.ld
...
all: $(BUILD_DIR)/$(TARGET).elf $(BUILD_DIR)/$(TARGET).hex $(BUILD_DIR)/$(TARGET).bin | $(OUT_DIR)
	cp $^ $(OUT_DIR)
	@echo "well done."
